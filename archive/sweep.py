...
train_encoded_labels = tl.get_word_list(1, 4)
train_sequence_files = tl.get_sequence_files(1, 4)

val_encoded_labels = tl.get_word_list(5, 5)
val_sequence_files = tl.get_sequence_files(5, 5)
